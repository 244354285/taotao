    ...
    <div class="g-0">
        <div id="content" class="c-3-5">
			...
			<div class="mod-main">
                        <div class="mt">
                            <ul class="extra-l">
                                <li class="fore-1"><a class="curr" href="javascript:;">基本信息</a></li>
                                <li class="fore-2"><a href="javascript:;">头像照片</a></li>
                        ...
                        <div class="mc">
                            ...
                            <div id="user-info">
                                <div class="u-pic">
                                    ...
                                    <a href="javascript:;" class="face-link">修改头像</a>
                                </div>
                                <div class="info-m">
									<div><b>用户名：dh189</b></div>
                                    <div class="u-level">
										<span class="rank r4">
											<s></s><a href="javascript:;" target="_blank">金牌会员</a>
										</span>
                                    </div>
